...
const messages = [
  ...
  },
  {
    portuguese: {
      ...
      notFound:
        'Desculpe, não entendi o que você deseja ou não encontrei a palavra-chave que você pesquisou. Lembre-se: para cidades, digite o nome e se necessário a sigla, ex: *!cidade Recife ou !cidade Moreno(PE)*, para estados digite *!sp ou !são paulo*, para relatório geral do brasil, digite *!brasil*, para relatório de todos os estados, digite *!todos* e para países, digite o nome em inglês, ex: *!netherlands, !uruguay*.',
      aboutMessage:
